...
let userID = 'f0ae0913-6fdb-4165-aa33-9cd21cef63c2';

const proxyIPs = ['8.209.108.248', '47.254.172.66', '47.254.182.210', 'cdn-all.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org']; // cdn-all.xn--b6gac.eu.org ,cdn.xn--b6gac.eu.org ,cdn-b100.xn--b6gac.eu.org, edgetunnel.anycast.eu.org, cdn.anycast.eu.org

let proxyIP = proxyIPs[Math.floor(Math.random() * proxyIPs.length)];

let dohURL = 'https://sky.rethinkdns.com'; // https://cloudflare-dns.com/dns-query or https://dns.google/dns-query
